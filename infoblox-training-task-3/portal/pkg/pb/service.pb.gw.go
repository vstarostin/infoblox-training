...
func RegisterPortalHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PortalServer) error {
	...
	mux.Handle("POST", pattern_Portal_Handler_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/portal.Portal/Handler", runtime.WithHTTPPathPattern("/"))
		if err != nil {
...
func RegisterPortalHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PortalClient) error {
	...
	mux.Handle("POST", pattern_Portal_Handler_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/portal.Portal/Handler", runtime.WithHTTPPathPattern("/"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Portal_Handler_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{""}, ""))
)
